"""
ATC Episode Player for interactive visualization.

This module provides the ATCPlayer class for visualizing recorded ATC episodes
with interactive controls for playback, speed adjustment, and timeline navigation.
"""
...
from .recorder import AircraftState
...
class ATCPlayer:
    ...
    def __init__(self, episode_data: Dict[str, Any], trail_length: int = 30):
        """
        Initialize ATC player.
        
        Args:
            episode_data: Episode data from ATCRecorder
            trail_length: Length of aircraft trails to show
        """
        ...
        logger.debug(f"ATCPlayer initialized: {len(self.timesteps)} timesteps")
    ...
    def _create_aircraft_triangle(self, x: float, y: float, heading: float, 
        ...
        Returns:
            Polygon object representing the aircraft
        """
    ...
    def _update_info_panel(self, frame: int) -> None:
        """
    ...
    def _seek_to_frame(self, val) -> None:
    ...
    def save_video(self, filepath: str, fps: int = 10) -> None:
        """
...
def visualize_episode(episode_data: Dict[str, Any], interactive: bool = True) -> ATCPlayer:
    """
